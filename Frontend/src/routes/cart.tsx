  ...
  const handlePlaceOrder = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (json.success && json.data) {
        /*
        // ==========================================
        // FUTURE PAYMENT GATEWAY INTEGRATION (RAZORPAY / STRIPE)
        // ==========================================
        // To enable card payments, UPI, etc., follow these steps:
        // 
        // 1. Add Razorpay/Stripe SDK script to your HTML header (index.html):
        //    <script src="https://checkout.razorpay.com/v1/checkout.js"></script>
        //
        // 2. Uncomment and adjust the code below:
        //
        const options = {
          key: "YOUR_RAZORPAY_KEY_ID", // Store in .env e.g. import.meta.env.VITE_RAZORPAY_KEY
          amount: json.data.total_amount * 100, // Amount in paise/cents
          currency: "INR",
          name: "Nexiscore",
          description: "Purchase Order: " + json.data.order_number,
          order_id: json.data.gateway_order_id, // Generated by your backend payment controller
          handler: async function (response: any) {
            // Verify payment signature on the backend:
            const verifyRes = await fetch(`${apiBase}/orders/verify`, {
              method: "POST",
              headers: { "Content-Type": "application/json" },
              body: JSON.stringify({
        ...
        */
        ...
        // DEFAULT FLOW: Bypasses payment gate and completes order immediately as Cash on Delivery
        setOrderSuccess(json.data.order_number);
        clear();
      } else {
